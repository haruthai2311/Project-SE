      ...
      <div class="main-panel">        
        <div class="content-wrapper">
          ...
          <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                           <label> ห้อง:<?php echo $row['id_room']; ?></label><br>

                            <label>เลขบัตรประจำตัวประชาชน:<?php echo  $row['id_ocp'] ?></label><br>

                            <label>ชื่อ:<?php echo  $row['name_ocp'] ?></label><br>
                            <label>นามสกุล:<?php echo $row['last_ocp'] ?> </label><br>
                            <label>เพศ:<?php echo $row['gender_ocp']; ?></label><br>
                            <label>เบอร์โทรศัพท์:<?php echo $row['phone_ocp']; ?></label><br>
                            <label>บุคคลที่ติดต่อได้กรณีฉุกเฉิน:</label><br>
                            <label>ชื่อ-สกุล: <?php echo  $row['contact_per'] ?></label><br>
                            <label>เบอร์โทรศัพท์: <?php echo $row['contact_phone'] ?></label><br>
                            <label>ความสัมพันธ์: <?php echo $row['contact_rlts'] ?></label><br>
                            <br>
                            <label>ที่อยู่ตามบัตรประชาชน: <?php echo $row['address'] ?></label><br>
