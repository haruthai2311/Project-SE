<?php include('../../../config.php');
  $sql = "SELECT * FROM `rooms` WHERE status_room = 'rented'";
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="../../pages/rooms/infomation.php||../../infomationempty.php||../../infomationnoempty.php">ข้อมูลห้อง</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="icons">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="../../pages/repairnotice/checkrepair.php">แจ้งปัญหาฃ</a></li>
              </ul>
            </div>
          </li>
        </ul>
        ...
        <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <button type="button" class="btn btn-inverse-primary btn-fw" onclick="document.location='infomation.php'"> ห้องทั้งหมด</button>
                  <button type="button" class="btn btn-inverse-success btn-fw"  onclick="document.location='infomationempty.php'" >ห้องว่าง</button>
                  <button type="button" class="btn btn-inverse-danger btn-fw"  onclick="document.location='infomationnoempty.php'" >ห้องมีผู้เช่า</button>
                  </p>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            ...
                            <?php echo $row['price_room']; ?>
                            
                          </td>
                                                    
                          <td><?php if($row['status_room']==('rented')){ ?>
                            <label class="badge badge-danger">&ensp;มีผู้เช่า&ensp;</label><?php }  ?></td>
