...
<body>
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="user_page.php"><img src="images/logo.svg" class="mr-2" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="user_page.php"><img src="images/logo-mini.svg" alt="logo"/></a>
      </div>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="tables">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="pages/roomrent/checkpaymentroom.php">สถานะการชำระ</a></li><!--ยังไม่สร้างหน้า-->
              </ul>
            </div>
          </li>
          <li class="nav-item">
