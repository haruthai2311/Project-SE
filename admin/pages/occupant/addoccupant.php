        ...
        <div class="content-wrapper ">
          <div class="row">
            <div class="col-12 grid-margin">
              <div class="card ">
                <div class="card-body">
                  <h3 class="card-title"  align="center" >เพิ่มข้อมูลผู้เช่า</h3>
                  <form  class="form-sample" method="POST" action="functionocp.php">
                    ...
                    <div class="row justify-content-md-center">
                      ...
                      <div class="col-md-5">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="id_ocp">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row justify-content-md-center">
                      <div class="col-md-5">
                        <div class="form-group">
                          <label>ชื่อ</label>
                          <input type="text" class="form-control"  name="name_ocp"/>
                        </div>
                      </div>
                      <div class="col-md-5">
                        <div class="form-group">
                          <label>นามสกุล</label>
                          <input type="text" class="form-control" name="last_ocp" />
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row justify-content-md-center">
                      ...
                      <div class="col-md-5">
                        <div class="form-group">
                          ...
                          <input class="form-control" type="tel" name="phone_ocp" pattern="[0-9]{10}" required oninvalid="this.setCustomValidity('กรุณาตรวจสอบความถูกต้องของเบอร์โทรศัพท์')"
                    ...
                    <div class="row justify-content-md-center">
                      <div class="col-md-10">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="contact_per"  />
                        </div>
                      </div>
                    ...
                    <div class="row justify-content-md-center">
                      <div class="col-md-5">
                        <div class="form-group">
                          <label>เบอร์โทรศัพท์</label>
                          <input class="form-control" type="tel" name="contact_phone" pattern="[0-9]{10}" required oninvalid="this.setCustomValidity('กรุณาตรวจสอบความถูกต้องของเบอร์โทรศัพท์')"
                          oninput="this.setCustomValidity('')">
                        </div>
                      </div>
                      <div class="col-md-5">
                        <div class="form-group">
                          ...
                          <input class="form-control" type="text" name="contact_rlts">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row justify-content-md-center">
                      <div class="col-md-5">
                        <div class="form-group">
                          <label>จังหวัด</label>
                          <input type="text" class="form-control" name="address5"  />
                        </div>
                      </div>
                      <div class="col-md-5">
                        <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-primary mr-2" name="addocp" id="save">Submit</button>
