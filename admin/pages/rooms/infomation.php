        ...
        <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <button type="button" class="btn btn-inverse-success btn-fw"  onclick="document.location='infomationempty.php'">&ensp;ห้องว่าง&ensp;</button>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><?php if($row['status_room']==('empty')){ ?>
                            <label class="badge badge-success" >&ensp;&ensp;ว่าง&ensp;&ensp;</label><?php } 
                            else {?>                          
                            <label class="badge badge-danger">&ensp;มีผู้เช่า&ensp;</label>
                          <?php } ?></td>
                        </tr>
