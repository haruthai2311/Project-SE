    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
        ...
        <ul class="navbar-nav navbar-nav-right">
          <li class="nav-item dropdown"> <!--รูปแจ้งเตือน-->
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"><a class="nav-link" href="pages/occupant/addoccupant.php">เพิ่มผู้เช่า</a></li><!--ยังไม่ใส่โค้ด-->
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="charts">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="pages/elecandwater/checkpayment.php">ตรวจสอบการชำระ</a></li><!--ยังไม่ใส่โค้ด-->
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="tables">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="pages/roomrent/checkpaymentroom.php">ตรวจสอบการชำระ</a></li><!--ยังไม่สร้างหน้า-->
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold"><div><?php  if (isset($_SESSION['USER'])) : ?><strong><?php echo "Hello   ",$_SESSION['USER']['name']; ?></strong><?php endif ?></div> </h3>
                ...
                <div class="card-people mt-auto">
                  ...
                  <div class="weather-info">
                    <div class="d-flex">
                      ...
                      <div class="ml-2">
                        <h4 class="location font-weight-normal">Sakon Nakhon</h4>
                        <h6 class="font-weight-normal">Thailand</h6>
                      </div>
                    </div>
                  </div>
                </div>
